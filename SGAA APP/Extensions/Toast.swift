...
//  User
//
//  Created by MacBookPro on 1/1/18.
...
//    func make(toast : String, completion : (()->Void)?=nil) {
////        DispatchQueue.main.async {
//            // let windows = UIApplication.shared.windows
//            print("Am IN")
//            print("The count \(windows.count)")
//            windows?.make(toast: toast)
////        }
//        if completion != nil {
